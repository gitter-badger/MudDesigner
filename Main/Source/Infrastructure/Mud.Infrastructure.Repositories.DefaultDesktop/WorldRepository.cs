...
namespace Mud.Repositories.Engine.DefaultDesktop
{
    ...
    public class WorldRepository : IWorldRepository
    {
        ...
        public Task<IEnumerable<IWorld>> GetAllWorlds(bool HydrateWorlds = false, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }

        public Task<IWorld> GetWorldForRealm(IRealm realm, bool HydrateWorld = false, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }

        public Task<IWorld> GetWorldById(Guid id, bool HydrateWorld = false, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }

        public Task SaveWorld(IWorld world, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }

        public Task SaveAllWorlds(IEnumerable<IWorld> worlds, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }

        public Task DeleteWorld(IWorld world, Mud.Engine.Core.Engine.IDataStoreContext context = null)
        {
            throw new NotImplementedException();
        }
    }

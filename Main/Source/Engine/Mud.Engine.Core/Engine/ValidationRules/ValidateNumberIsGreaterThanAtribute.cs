...
{
    public class ValidateNumberIsGreaterThanAtribute : ValidationAttribute
    {
        /// <summary>
        ...
        private IValidationMessage ValidateIntegerValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = int.TryParse(this.GreaterThanValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateLongValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = long.TryParse(this.GreaterThanValue, NumberStyles.Integer, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateFloatValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = float.TryParse(this.GreaterThanValue, NumberStyles.Float, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDoubleValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = double.TryParse(this.GreaterThanValue, NumberStyles.Number, null, out convertedMinimumValue);
        ...
        private IValidationMessage ValidateDecimalValueIsGreaterThan(object propertyValue, object alternateProperty, IValidationMessage validationMessage)
        {
            ...
            bool valueComparisonConversionSucceeded = decimal.TryParse(this.GreaterThanValue, NumberStyles.Number, null, out convertedMinimumValue);
